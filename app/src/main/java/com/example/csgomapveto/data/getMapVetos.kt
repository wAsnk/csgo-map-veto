...
fun getMapVetos(teamList: List<Team>): List<MapVeto> {
    ...
    mapVetoList.add(
    MapVeto(Name = teamList[0].Name + " vs. " + teamList[1].Name, Team1 = teamList[0].id, Team2 = teamList[1].id, VetoList = listOf<Veto>(
    ...
    mapVetoList.add(
    MapVeto(Name = teamList[2].Name + " vs. " + teamList[3].Name, Team1 = teamList[2].id, Team2 = teamList[3].id, VetoList = listOf<Veto>(
    ...
    mapVetoList.add(
    MapVeto(Name = teamList[4].Name + " vs. " + teamList[5].Name, Team1 = teamList[4].id, Team2 = teamList[5].id, VetoList = listOf<Veto>(
    ...
    mapVetoList.add(
    MapVeto(Name = teamList[1].Name + " vs. " + teamList[4].Name,Team1 = teamList[1].id, Team2 = teamList[4].id, VetoList = listOf<Veto>(
